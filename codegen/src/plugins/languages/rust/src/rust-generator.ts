/**
 * Rust Generator - generates Rust code from templates
 * Implements ILanguageGenerator with declarative JSON specs
...
/**
 * Rust Generator - generates Rust code from declarative templates
 ...
 */
export class RustGenerator extends BaseComponent implements ILanguageGenerator {
  ...
  /**
   * Generate Rust code from template and context
   * @param context
   */
  ...
  /**
   * Validate spec contains required Rust data
   * @param spec
   */

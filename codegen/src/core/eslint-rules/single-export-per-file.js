  ...
  rules: {
    'single-export-per-file': {
      meta: {
        type: 'problem',
        docs: {
          description: 'Enforces single export per file - each file should export exactly 1 class, interface, function, or constant',
        ...
        messages: {
          multipleExports: 'File "{{file}}" violates single export rule: {{violations}}. Each file should export exactly 1 class, interface, function, or constant.',
          inlineInterface: 'File "{{file}}" contains inline interface definitions in constructor parameters. All types must be defined in separate files.',
        },
      },
      ...
      create(context) {
        ...
        const allowBarrelExports = options.allowBarrelExports !== false;

describe("bootstrap/services/cdn/dynamic-modules-service.js", () => {
  const modulePath = '../../../../../bootstrap/services/cdn/dynamic-modules-service.js';
  const moduleName = 'dynamic-modules-service.js';

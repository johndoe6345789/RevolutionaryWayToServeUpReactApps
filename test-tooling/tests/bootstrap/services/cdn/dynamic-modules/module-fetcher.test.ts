describe("bootstrap/services/cdn/dynamic-modules/module-fetcher.js", () => {
  const modulePath = '../../../../../../bootstrap/services/cdn/dynamic-modules/module-fetcher.js';
  const moduleName = 'module-fetcher.js';

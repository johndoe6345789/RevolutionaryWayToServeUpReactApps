describe("bootstrap/services/cdn/dynamic-modules/module-fetcher-config.js", () => {
  const modulePath = '../../../../../../bootstrap/services/cdn/dynamic-modules/module-fetcher-config.js';
  const moduleName = 'module-fetcher-config.js';

describe("bootstrap/services/cdn/dynamic-modules/provider-resolver-config.js", () => {
  const modulePath = '../../../../../../bootstrap/services/cdn/dynamic-modules/provider-resolver-config.js';
  const moduleName = 'provider-resolver-config.js';

describe("bootstrap/services/cdn/network/network-module-resolver.js", () => {
  const modulePath = '../../../../../../bootstrap/services/cdn/network/network-module-resolver.js';
  const moduleName = 'network-module-resolver.js';

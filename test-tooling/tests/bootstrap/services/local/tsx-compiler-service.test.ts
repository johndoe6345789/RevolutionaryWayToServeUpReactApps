describe("bootstrap/services/local/tsx-compiler-service.js", () => {
  const modulePath = '../../../../../bootstrap/services/local/tsx-compiler-service.js';
  const moduleName = 'tsx-compiler-service.js';

describe("bootstrap/services/local/local-loader-service.js", () => {
  const modulePath = '../../../../../bootstrap/services/local/local-loader-service.js';
  const moduleName = 'local-loader-service.js';

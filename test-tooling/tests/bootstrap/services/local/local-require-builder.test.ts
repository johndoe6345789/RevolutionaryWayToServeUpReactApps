describe("bootstrap/services/local/local-require-builder.js", () => {
  const modulePath = '../../../../../bootstrap/services/local/local-require-builder.js';
  const moduleName = 'local-require-builder.js';

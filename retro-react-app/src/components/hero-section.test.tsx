...
describe('HeroSection', () => {
  ...
  it('renders the hero section with all required elements', () => {
    ...
    // Check description
    expect(screen.getByText('Discover the ultimate retro gaming experience...')).toBeInTheDocument();

    // Check buttons
    expect(screen.getByRole('button', { name: /launch arcade mode/i })).toBeInTheDocument();
    expect(screen.getByRole('button', { name: /browse rom library/i })).toBeInTheDocument();
  ...
  it('renders the console icon with correct text', () => {
    ...
    const heroSection = screen.getByText('Press Start').closest('.MuiBox-root')?.parentElement;
  ...
  it('renders with responsive layout classes', () => {
    ...
    const mainContainer = screen.getByText('Press Start').closest('.MuiBox-root')?.parentElement;

// We need to create a mock implementation for GlobalRootHandler to replace the real one in tests
// This is a mock file that will be used to replace the actual GlobalRootHandler in tests
